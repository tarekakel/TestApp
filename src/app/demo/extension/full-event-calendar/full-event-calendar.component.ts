...
export class FullEventCalendarComponent implements OnInit {
  dateObj = new Date();
  yearMonth =
    this.dateObj.getUTCFullYear() + '-' + (this.dateObj.getUTCMonth() + 1);
  ...
  calendarOptions: CalendarOptions = {
    ...
    events: [
      ...
      },
      {
        title: 'Meeting',
        start: formatDate(
          this.yearMonth + '-12 10:00:00 PM',
          'yyyy-MM-dd hh:mm:ss',
          'en-US'
        ),
        end: formatDate(
          this.yearMonth + '-12 12:30:00 AM',
          'yyyy-MM-dd hh:mm:ss',
          'en-US'
        ),
        textColor: '#fff',
