...
function generateDataSabraThat(
  count: number,
...
function generateDatasehratheatbubble3d(
  baseval: number,
  count: number,
  yrange: { min: any; max: any }
) {
...
function generateDatasehratheat(count: number, yrange: { min: any; max: any }) {
  let i = 0;
  const series = [];
  while (i < count) {
    series.push({
...
function generateDatasehrat(count: number, yrange: { min: any; max: any }) {
  let i = 0;
  const series = [];
  while (i < count) {
    series.push({
