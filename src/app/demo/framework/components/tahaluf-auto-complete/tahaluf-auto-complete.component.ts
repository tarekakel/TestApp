...
export class TahalufAutoCompleteComponent
  ...
  implements ControlValueAccessor
{
  ...
  @Input('value-field') valueField: string | undefined;
  @Input('text-field') textField: string | undefined;
  ...
  //   'Common.AutoCompletePlaceholder'
  // );
  @Input('empty-message') emptyMessage: string = '';
  // =
  //   this.translationService.translate('Common.AutoCompleteEmptyMessage');
  ...
  constructor(
    private primengGridHelper: PrimengGridHelper<CustomerProfileSearchFilter>,
