...
export class TahalufDateTimePickerComponent extends BaseComponent implements ControlValueAccessor, OnInit {
  ...
  @Input('disabled-dates') disabledDates: Array<Date> = null;
  @Input('disabled-days') disabledDays: Array<number> = null;
